...
//instanciacion del procesamiento para cada linea
EnergyMonitor emon_Y;
EnergyMonitor emon_B;
EnergyMonitor emon_R;


//Calibracion de corriente,tension y factor de potencia
#define vCalibration_Y      132.92997062
#define currCalibration_Y   13.05470228
#define PowerFactor_Y  0  


#define vCalibration_B      132.88733704
#define currCalibration_B   13.04602483
#define PowerFactor_B  0  


#define vCalibration_R      133.05720892
#define currCalibration_R   12.91133407
#define PowerFactor_R 0  
...
void Console_Power() {
    //Realiza los calculos de potencia para las tres lineas
    emon_Y.calcVI(500, 5000);
    emon_B.calcVI(500, 5000);
    emon_R.calcVI(500, 5000);
